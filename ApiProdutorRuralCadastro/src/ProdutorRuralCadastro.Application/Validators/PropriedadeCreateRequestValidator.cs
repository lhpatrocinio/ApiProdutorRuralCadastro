...
/// <summary>
/// Validador FluentValidation para criação de propriedade
/// </summary>
public class PropriedadeCreateRequestValidator : AbstractValidator<PropriedadeCreateRequest>
{
    public PropriedadeCreateRequestValidator()
    {
        RuleFor(x => x.ProdutorId)
            .NotEmpty()
            .WithMessage("ProdutorId é obrigatório");
