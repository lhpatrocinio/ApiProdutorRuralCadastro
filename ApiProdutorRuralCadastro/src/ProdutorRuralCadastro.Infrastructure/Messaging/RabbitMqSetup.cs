...
namespace ProdutorRuralCadastro.Infrastructure.Messaging;
...
public class RabbitMqSetup : IAsyncDisposable
{
    ...
    public const string AlertCreatedQueue = "cadastro.alert.created";
    public const string DeadLetterQueue = "agro.events.dlq";
    public const string AlertCreatedRoutingKey = "alert.created.#";
    ...
    public async Task InitializeAsync()
    {
        try
        {
            ...
            // Configurar Queue para AlertCreatedEvent com DLX
